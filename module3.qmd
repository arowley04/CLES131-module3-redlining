...
```{r}
# Read in data 
baltimore <- st_read("data/baltimore/balt_geojson.json") ###NOT RUNNING
baltimore  
st_crs(baltimore)
```
...
```{r}
# Import data 
balt_b04 <- rast("data/baltimore/T18SUJ_20250603T155001_B04_10m copy.jp2")
balt_b08 <- rast("data/baltimore/T18SUJ_20250603T155001_B08_10m copy.jp2")

birm_b04 <- rast("data/birmingham /T16SEC_20190831T162839_B04_10m.jp2") 
birm_b08 <- rast("data/birmingham /T16SEC_20190831T162839_B08_10m.jp2") 

indy_b04 <- rast("data/indianapolis/T16TEK_20251003T163141_B04_10m.jp2")
indy_b08 <- rast("data/indianapolis/T16TEK_20251003T163141_B08_10m.jp2")

minn_b04 <- rast("data/minneapolis/T15TVK_20190808T170901_B04_10m.jp2")
minn_b08 <- rast("data/minneapolis/T15TVK_20190808T170901_B08_10m.jp2")

phe_b04 <- rast("data/pheonix/T12SUC_20221118T181641_B04_10m.jp2")
phe_b08 <- rast("data/pheonix/T12SUC_20221118T181641_B08_10m.jp2")
```

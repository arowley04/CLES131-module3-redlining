...
```{r}
# Read in data 
baltimore <- st_read("data/J_20250603T155001_B08_10m copy.jp2")
baltimore  
st_crs(baltimore)

birmingham <- st_read("data/T16SEC_20190831T162839_B04_10m.jp2")
birmingham  
st_crs(birmingham)
```
